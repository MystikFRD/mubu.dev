...
const Footer = ({}) => {
  const openDiscord = () => {
    window.open('https://discord.gg/C3UFFu5B9u', '_blank', 'noopener,noreferrer');
  };
        ...
        <div className="max-w-screen-xl mx-auto">
          <div>
            ...
            <div className="mt-10">
              ...
              <Button
                  type="primary"
                  className="mt-6 hover:opacity-80 transition-opacity duration-300 flex items-center gap-2"
                  onClick={openDiscord}
              >
                <svg
                    className="w-6 h-6"
